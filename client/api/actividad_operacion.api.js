...
const getActividadByIdRequest = async (id) => {
  try {
    ...
    return res.json({
      message: "Error al buscar actividad por id",
      error: error.message,
    });
  }
};
...
const deleteActividadRequest = async (id, res) => {
  try {
    ...
    return res.json({
      message: "Error al elminar actividad",
      error: error.message,
    });
  }
};
...
const getActividadesByOperacionRequest = async (id) => {
  try {
    const response = await axios.get(`actividad/operacion/${id}`);
    return response;
  } catch (error) {
    return res.json({
      message: "Error al buscar actividades por operacion",
      error: error.message,
    });
  }
};
...
export default {
  getActividadesByOperacionRequest,
